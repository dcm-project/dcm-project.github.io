...
[DCM-AI-PROMPT.md](DCM-AI-PROMPT.md) — load into any AI model to provide full project context. 98 sections covering the complete architecture, all decisions, and working instructions.
